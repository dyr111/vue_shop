  ...
  data () {
    ...
    return {
      ...
      addFormRules: {
        ...
        mobile: [
          { required: true, message: '请输入手机号', trigger: 'blur' }, { validator: checkMobil, trigger: 'blur' }
      ]
    },
    // 控制修改用户对话框的显示与隐藏
    ...
    editFormRules: {
      email: [
        { required: true, message: '请输入用户邮箱', tigger: 'blur' }, { validator: checkEmail, tigger: 'blur' }
      ],
      mobile: [
        { required: true, message: '请输入用户手机号', tigger: 'blur' }, { validator: checkMobil, tigger: 'blur' }
      ]
    },
    // 控制分配角色对话框的显示与隐藏
